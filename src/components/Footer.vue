<template>
  <footer class="page-footer font-small teal p-3">
    <div class="footer-icons">
      <!-- LinkedIn -->
      <a href="https://www.linkedin.com/in/sebscholl/" target="_blank">
        <svg
      ...
      <!-- YouTube -->
      <a href="https://www.youtube.com/c/8base" target="_blank">
        <svg
          fill="black"
          width="50"
          height="50"
      ...
      <!-- Github -->
      <a href="https://github.com/sebscholl" target="_blank">
        <svg
          fill="black"
          width="50"
          height="50"
      ...
      <!-- Medium -->
      <a href="https://medium.com/@sebscholl" target="_blank">
        <svg
          fill="black"
          width="50"
          height="50"
      ...
      <!-- Twitter -->
      <a href="https://twitter.com/SebScholl" target="_blank">
        <svg
          fill="black"
          width="50"
          height="50"
